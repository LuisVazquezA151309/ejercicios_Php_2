 ...
 <header>
    <div class="logo">
     ...
     <div ALIGN=left><h3> PROGRAMACION DE APLICACIONES WEB</h3></div>
                    ...
                    <br>
                    <br>
                    <center><h4>Programa que solicita el nombre de una persona y su edad, luego mostrar en pantalla si es mayor o menor de edad.</h4>
					 </center>
					 <br>
	<br>
	<br>
    <div><center>
        <form name="formulario" method="post" action="solicitud_6.php">
    ...
    <br>  
     ...
     <center><h2><a href="index.php">Regresar al menu</a></h2></center>
      <br>
    <br>
    <br>  <br>
    <br>
