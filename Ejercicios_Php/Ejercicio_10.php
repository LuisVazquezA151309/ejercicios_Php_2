    ...
    <div class="logo">
        ...
        <table width="auto" height="auto" > 
            ...
            <div class="container">
                    ...
                    <br>
                    <br>
                    <center><h4>Tabla de multiplicar</h4>
					 </center>
					 <br>
	<br>
	<br>
    <div><center>
        <form name="formulario" method="post" action="tabla_10.php">
       Numero:<input type="text" name="tablas" value="">
